...
import HomeTask from '@/pages/HomeTask.vue'
import costumersList from '@/pages/CostumersList.vue'
import CreatePage from '@/pages/CreateCustomer.vue'
import UpdatePage from '@/pages/UpdateCustomer.vue'
